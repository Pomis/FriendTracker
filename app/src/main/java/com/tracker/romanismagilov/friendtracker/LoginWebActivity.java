...
import com.tracker.romanismagilov.friendtracker.api.Auth;
...
public class LoginWebActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://oauth.vk.com/authorize?client_id=" + LogInActivity.API_ID + "&scope=wall,offline,friends,messages=&response_type=token";
